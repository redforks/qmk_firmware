...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_ergodox(KC_GRV, KC_1, KC_2, KC_3, KC_4, KC_5, KC_F3, KC_SLSH, LGUI_T(KC_QUOT), LALT_T(KC_COMM), LCTL_T(KC_DOT), LSFT_T(KC_P), KC_Y, KC_LBRC, KC_TAB, KC_A, KC_O, KC_E, KC_I, KC_U, KC_ESC, LT(2,KC_SCLN), KC_Q, KC_J, KC_K, KC_X, KC_DLR, OSM(MOD_MEH), KC_NO, KC_NO, KC_LEAD, OSL(1), KC_HOME, KC_APP, KC_CAPS, KC_ENT, KC_LSFT, KC_INS, KC_F5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_BSPC, KC_RBRC, KC_F, LSFT_T(KC_G), LCTL_T(KC_C), LALT_T(KC_R), LGUI_T(KC_L), KC_BSLS, KC_D, KC_H, KC_T, KC_N, KC_S, KC_MINS, KC_EXLM, KC_B, KC_M, KC_W, KC_V, LT(2,KC_Z), KC_EQL, OSL(1), KC_LEAD, KC_NO, KC_NO, OSM(MOD_MEH), KC_PGUP, KC_END, KC_PGDN, KC_DEL, KC_RSFT, KC_SPC),
