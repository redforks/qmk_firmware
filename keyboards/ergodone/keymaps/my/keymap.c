...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_ergodox(KC_GRV, KC_1, KC_2, KC_3, KC_4, KC_5, KC_BSLS, KC_SLSH, KC_QUOT, KC_COMM, KC_DOT, KC_P, KC_Y, KC_LBRC, KC_TAB, LGUI_T(KC_A), LALT_T(KC_O), LSFT_T(KC_E), LCTL_T(KC_U), KC_I, KC_ESC, LT(2,KC_SCLN), KC_Q, KC_J, KC_K, KC_X, KC_DLR, OSL(1), KC_NO, KC_LEAD, KC_LEFT, KC_RGHT, KC_HOME, KC_NO, KC_CAPS, KC_ENT, KC_DEL, KC_INS, KC_NO, KC_6, KC_7, KC_8, KC_9, KC_0, KC_NO, KC_RBRC, KC_F, KC_G, KC_C, KC_R, KC_L, KC_EQL, KC_D, LCTL_T(KC_H), LSFT_T(KC_T), LALT_T(KC_N), LGUI_T(KC_S), KC_MINS, KC_EXLM, KC_B, KC_M, KC_W, KC_V, LT(2,KC_Z), KC_NO, KC_DOWN, KC_UP, KC_LEAD, KC_NO, OSL(1), KC_PGUP, KC_END, KC_PGDN, KC_NO, KC_BSPC, KC_SPC),
