...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[2] = LAYOUT_ergodox(KC_SLEP, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_MS_U, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_MS_L, KC_MS_D, KC_MS_R, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_BTN2, KC_BTN1, KC_WH_L, KC_WH_R, KC_WH_U, KC_BTN3, KC_NO, KC_WH_D, KC_NO, KC_NO, KC_NO, KC_PSLS, KC_PAST, KC_PMNS, KC_NO, KC_NO, KC_NO, KC_7, KC_8, KC_9, KC_PPLS, KC_NO, KC_NO, KC_4, KC_5, KC_6, KC_PMNS, KC_NO, KC_NO, KC_NO, KC_1, KC_2, KC_3, KC_ENT, KC_NO, KC_0, KC_ACL1, KC_DOT, KC_NO, KC_NO, KC_MUTE, KC_NO, KC_VOLU, KC_VOLD, KC_ACL2, KC_ACL0)
};
