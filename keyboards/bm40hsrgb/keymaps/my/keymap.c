...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_planck_mit(TD(TD_SLASH), LGUI_T(KC_QUOT), LALT_T(KC_COMM), LCTL_T(KC_DOT), LSFT_T(KC_P), KC_Y, KC_F, LSFT_T(KC_G), LCTL_T(KC_C), LALT_T(KC_R), LGUI_T(KC_L), KC_BSPC, KC_TAB, KC_A, KC_O, KC_E, KC_I, KC_U, KC_D, KC_H, KC_T, KC_N, KC_S, KC_ENT, KC_ESC, LT(6,KC_SCLN), KC_Q, KC_J, KC_K, KC_X, KC_B, KC_M, KC_W, KC_V, KC_Z, KC_MINS, MO(4), TG(7), MO(5), KC_LEAD, MO(2), LT(1,KC_SPC), MO(2), KC_NO, KC_CAPS, KC_NO, MO(3)),
	...
	[4] = LAYOUT_planck_mit(LALT(KC_GRV), LALT(KC_1), LALT(KC_2), LALT(KC_3), LALT(KC_4), LALT(KC_5), LALT(KC_6), LALT(KC_7), LALT(KC_8), LALT(KC_9), LALT(KC_0), LALT(KC_F12), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, LALT(KC_F7), LCA(KC_T), KC_NO, KC_NO, LALT(KC_ENT), KC_RSFT, KC_NO, KC_NO, LCA(KC_J), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, LCA(KC_INS), HYPR(KC_SPC), LALT(KC_INS), KC_NO, KC_NO, LCTL(KC_F10), KC_F5),
