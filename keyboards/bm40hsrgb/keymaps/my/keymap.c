...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_planck_mit(TD(TD_SLASH), LCTL_T(KC_QUOT), LALT_T(KC_COMM), LGUI_T(KC_DOT), LSFT_T(KC_P), KC_Y, KC_F, LSFT_T(KC_G), LCTL_T(KC_C), LALT_T(KC_R), LGUI_T(KC_L), KC_BSPC, KC_TAB, KC_A, KC_O, KC_E, KC_I, KC_U, KC_D, KC_H, KC_T, KC_N, KC_S, KC_MINS, KC_ESC, LT(6,KC_SCLN), KC_Q, KC_J, KC_K, KC_X, KC_B, KC_M, KC_W, KC_V, KC_Z, KC_ENT, MO(4), TG(7), MO(5), KC_LEAD, MO(2), LT(1,KC_SPC), MO(2), KC_NO, KC_CAPS, TO(8), MO(3)),
	...
	[2] = LAYOUT_planck_mit(KC_LALT, KC_F1, KC_F2, KC_F3, KC_F4, PHP_SELF, KC_NO, KC_HOME, KC_UP, KC_END, KC_PGUP, KC_NO, KC_RCTL, KC_F5, KC_F6, KC_F7, KC_F8, PHP_THIS, KC_NO, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, KC_NO, KC_RSFT, KC_F9, KC_F10, KC_F11, KC_F12, PHP_ARROW, KENNER_DB, VIM_YANK, VIM_PASTE, KC_DEL, KC_INS, KC_RSFT, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS, KC_NO, KC_TRNS, KC_NO, KC_NO, KENNER_CRM, KC_RCTL),
	...
	[5] = LAYOUT_planck_mit(KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, RESET, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS, KC_NO, KC_NO, KC_SLEP, KC_NO, KC_NO, KC_MUTE, KC_VOLD, KC_VOLU),
	...
	[8] = LAYOUT_planck_mit(KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_GRV, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS, KC_LSFT, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, OSM(MOD_LSFT|MOD_LGUI), KC_LGUI, KC_RALT, KC_RCTL, KC_RSFT, KC_NO, KC_NO, OSM(MOD_MEH), OSM(MOD_LSFT|MOD_LALT), OSM(MOD_LCTL|MOD_LSFT), OSM(MOD_LCTL|MOD_LALT), KC_RGUI)
};
